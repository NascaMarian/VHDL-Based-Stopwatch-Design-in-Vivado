...
set_property PACKAGE_PIN T18 [get_ports {buttonbus[3]}]
	set_property IOSTANDARD LVCMOS33 [get_ports {buttonbus[3]}]
set_property PACKAGE_PIN W19 [get_ports {buttonbus[2]}]
	set_property IOSTANDARD LVCMOS33 [get_ports {buttonbus[2]}]
set_property PACKAGE_PIN T17 [get_ports {buttonbus[0]}]
	set_property IOSTANDARD LVCMOS33 [get_ports {buttonbus[0]}]
set_property PACKAGE_PIN U17 [get_ports {buttonbus[1]}]
	set_property IOSTANDARD LVCMOS33 [get_ports {buttonbus[1]}]
